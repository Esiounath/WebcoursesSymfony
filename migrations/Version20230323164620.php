 ...
 */
final class Version20230323164620 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE form (id INT AUTO_INCREMENT NOT NULL, day DATE NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, sexe TINYINT(1) NOT NULL, epreuve_choisie VARCHAR(255) NOT NULL, parcours VARCHAR(255) NOT NULL, taille_maillot VARCHAR(255) NOT NULL, temps_annoncer INT NOT NULL, numero_dossard INT NOT NULL, categorie_age VARCHAR(255) NOT NULL, type_epreuve VARCHAR(255) NOT NULL, birth DATE NOT NULL, date_epreuve DATE NOT NULL, ip VARCHAR(255) NOT NULL, valide INT NOT NULL, password VARCHAR(255) NOT NULL, identifiant VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE epreuve (ep_id INT NOT NULL, pa_id INT NOT NULL, typep_id INT NOT NULL, ma_id INT NOT NULL, ep_nom VARCHAR(50) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_general_ci`, ep_lieu VARCHAR(50) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_general_ci`, ep_datedeb DATE DEFAULT NULL, ep_datefin DATE DEFAULT NULL, INDEX ma_id (ma_id), INDEX typep_id (typep_id), INDEX pa_id (pa_id), PRIMARY KEY(ep_id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
